function [obj_min,x_rsp]=func_simplepathleastvar(A,b,mu,covSigma,x_let)
...
ub=ones(num_edges,1);
x_rsp_quadprog=zeros(num_edges,1);
[x_rsp_quadprog,~,exitflag]=quadprog(2*covSigma,[],[],[],A,b,lb,ub); % x_rsp_quadprog is the optimal solution of the (continously) relaxed problem
